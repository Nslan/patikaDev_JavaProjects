...
public abstract class Account implements Comparable<Account>{ //nesne uretilmeyecek
    private User user;
    ...
    public void printInsurances(){
        for(Insurance insurance: user.getInsuranceList()){
            System.out.println("Sigorta Türü : "+insurance.getInsuranceName()+", Ücreti : "+ insurance.getInsurancePrice()+
                    ", Başlangıç Tarihi : "+insurance.getInsuranceStartDate()+", Bitiş Tarihi : "+ insurance.getInsuranceFinishDate() );
        }
    }
